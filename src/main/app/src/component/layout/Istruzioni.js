...
function Istruzioni() {
  return (
    <Container>
      ...
      <p>
        1. Scopo del gioco: Si parte sempre dall’obiettivo segreto scritto sulla
        carta che ogni giocatore riceverà ad inizio partita: la vittoria sarà
        del primo giocatore che raggiunge il suo obiettivo segreto. <br />
        2. Tabellone: Il tabellone di gioco è una mappa di 6 continenti divisi
        in 42 territori. Ogni continente è di un colore diverso e comprende da 4
        a 12 territori. <br />
        ...
        di 5 fanteria), Artiglieria (del valore di 10 Fanteria, o 2 Cavalleria).{" "}
        <br />
        ...
        distribuiti. <br />
        5. Turno di gioco: Durante il proprio turno ogni giocatore può svolgere
        tre attività principali: rinforzare le proprie armate, attaccare,
        spostare. <br />
      </p>
